class doandroid::sdk (
  ...
  if ($include_adt) {
    ...
    exec { 'doandroid-sdk-android-download-expand-cleanup' :
    ...
    concat::fragment { 'doandroid-android-bashrc-paths':
    ...
    exec { 'doandroid-sdk-android-update':
      ...
      timeout => 60*60,
      require => [Exec['doandroid-sdk-android-download-expand-cleanup']],
    }
  }
